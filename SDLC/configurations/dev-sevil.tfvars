...
s3_tfstate_file = "sevil.tfstate" #Will be used to set backend.tf 
...
region= "us-east-1"
 ...
 #At the company they can say go copy dev enviromet make it yours and play arround 
 #put your name tfstate file and build vpc in dev-sevil environment  with your name test it and derstroy 
